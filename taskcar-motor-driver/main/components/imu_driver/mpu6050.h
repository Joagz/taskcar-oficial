...
typedef struct
{
    ...
    float x_acc; /*!< X AXIS ACCELEROMETER DATA */
    float y_acc; /*!< Y AXIS ACCELEROMETER DATA */
    float z_acc; /*!< Z AXIS ACCELEROMETER DATA */

    float x_deg; /*!< X AXIS GYROSCOPE DATA */
    float y_deg; /*!< Y AXIS GYROSCOPE DATA */
    float z_deg; /*!< Z AXIS GYROSCOPE DATA */
